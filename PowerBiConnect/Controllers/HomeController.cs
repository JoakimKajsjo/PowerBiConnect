...
namespace PowerBiConnect.Controllers
{
    public class HomeController : Controller
    {
        ...
        readonly string redirectUri = "http://localhost:13526/Home/Index";
        ...
        {
            appId = configuration["ConnectApp:applicationId"];
            appSecret = configuration["ConnectApp:applicationSecret"];
        }
